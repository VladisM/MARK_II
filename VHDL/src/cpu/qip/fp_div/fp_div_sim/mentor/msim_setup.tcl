...
# ----------------------------------------
# If fp_div is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 linux 2018.02.15.13:09:43
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/opt/Quartus_17/quartus/"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fp_div_memoryC0_uid113_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_div_memoryC1_uid116_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_div_memoryC2_uid120_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_div_memoryC1_uid117_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_div_memoryC0_uid112_invTables_lutmem.hex ./
}
...
alias dev_com {
  ...
  if ![ string match "*ModelSim ALTERA*" [ vsim -version ] ] {
    ...
    eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/fiftyfivenm_atoms_ncrypt.v" -work fiftyfivenm 
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_div.vhd"               
}
