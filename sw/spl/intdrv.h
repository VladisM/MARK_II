...
#define INTMR_uart0_en  0x00000200
#define INTMR_uart0_en  0x00000400
#define INTMR_tim0_en   0x00004000
#define INTMR_tim0_en   0x00008000
#define INTMR_tim0_en   0x00010000
#define INTMR_tim0_en   0x00020000
